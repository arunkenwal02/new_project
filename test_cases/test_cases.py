...
class TestModelPipeline(unittest.TestCase):
    ...
    def test_random_forest_pipeline(self):
        ...
        self.assertTrue(0 <= accuracy_rf <= 1, "Random Forest accuracy should be between 0 and 1")
    ...
    def test_svc_pipeline(self):
        ...
        self.assertTrue(0 <= accuracy_svm <= 1, "SVM accuracy should be between 0 and 1")
    ...
    def test_logistic_regression_pipeline(self):
        ...
        self.assertTrue(0 <= accuracy_lr <= 1, "Logistic Regression accuracy should be between 0 and 1")
    ...
    def test_knn_pipeline(self):
        ...
        self.assertTrue(0 <= accuracy_knn <= 1, "KNN accuracy should be between 0 and 1")
    ...
    def test_random_forest_with_cv(self):
        ...
        self.assertTrue(0 <= accuracy_rf_cv <= 1, "Random Forest CV accuracy should be between 0 and 1")

    # Test Case 6: Test SVC with GridSearchCV
    def test_svc_with_cv(self):
        param_grid_svm = {
            'C': [0.1, 1, 10, 50, 100],
        ...
        self.assertTrue(0 <= accuracy_svm_cv <= 1, "SVM CV accuracy should be between 0 and 1")
