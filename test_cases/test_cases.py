...
# This test case checks if the accuracy scores are calculated without errors.
# How to Perform:
...
assert isinstance(accuracy_rf, float), "Random Forest accuracy is not a float"
assert isinstance(accuracy_svm, float), "SVM accuracy is not a float"
assert isinstance(accuracy_lr, float), "Logistic Regression accuracy is not a float"
assert isinstance(accuracy_knn, float), "KNN accuracy is not a float"

# Test Case 8: Hyperparameter Tuning Validation
# This test case ensures that hyperparameter tuning is performed without errors and best parameters are found.
# How to Perform:
...
# This test case checks if the classification report is generated without errors.
# How to Perform:
